<template>
  <Sider hide-trigger class="slider-div">
    <!-- 管理员菜单栏 -->
    <Menu
      ...
      <MenuGroup title="基础信息">
        ...
        <MenuItem name="/bilibili" to="/bilibili">
          ...
          <span style="padding-right:5px;padding-top:2px;">
            <svg t="1587913768034" class="icon" viewBox="0 0 1069 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                 p-id="2406" width="14" height="14"><path
